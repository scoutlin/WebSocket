...
First steps
WebSocket's communicate over a TCP (Transmission Control Protocol) connection, luckily C# has a TcpListener class which does as the name suggests.
...
namespace WebSocketServer
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            MyWebServer mMyWebServer = new MyWebServer();
        }
    }
